...
public class LinearEquationTest09_12 {
    ...
    private static void displayTheIntersectingPoints(LinearEquation equation) {
    if(equation.isSolvable()){
        System.out.println("The intersecting point is at " + equation.getX() + equation.getY());
    }else System.out.println("The equatian has no root , they are parallel");
    }

    private static double[][] getFromUser() {
